...
const Portfolio = () => {
  return (
    <section className="text-gray-600 body-font overflow-hidden px-4 py-4 bg-white h-auto">
      <h2 className="text-center mt-4 font-bold underline text-3xl title-font text-black tracking-widest">Projects</h2>
      <div className="container px-5 items-center justify-center mx-auto py-4">
