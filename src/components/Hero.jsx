...
const Hero = () => {
  return (
    <div id='home' className='flex px-4 md:px-8  flex-wrap w-full lg:h-screen h-fit justify-center items-center bg-slate-500'>
      <div className='md:w-1/2 w-full items-center py-8 md:py-12 lg:py-0'>
        <div>
          <TypeAnimation
            sequence={[
            ...
            className="md:text-3xl z-10 md:pt-0 pt-8 text-2xl  md:text-left text-center w-full font-bold text-white"
            repeat={Infinity}
            wrapper="h1"
          />
          <div className=' text-center md:text-left'>
            ...
            <li className='list-none flex justify-center md:justify-start w-full gap-6 mt-6 duration-500'>
              ...
              <svg
                ...
                height="2em"
                width="2em"
                className='hover:fill-gray-200 active:fill-black shadow-xl hover:scale-110 transition-all'
              >
              ...
              <a href='tel:+260979054417'>
                <svg
                  ...
                  height="2em"
                  width="2em"
                  className='hover:fill-gray-200 active:fill-black shadow-xl rounded-full hover:scale-110 transition-all'
                >
            ...
            <button className='bg-white py-1 shadow-xl px-4 rounded mt-8 text-slate-500 font-bold hover:bg-slate-700 hover:text-white transition-all'>
