...
const About = () => {
    return (
        <section id='about' className='flex px-4 md:px-8 flex-col md:flex-row-reverse justify-center items-center md:py-0 py-8 w-full h-fit md:h-screen'>
            <div className='flex md:w-1/2 w-full ml-0 md:ml-6'>
                <div className='flex flex-col w-full text-center md:text-left '>
                    <h1 className='font-bold md:text-3xl text-2xl text-slate-600'>About</h1>
                    <p className='mt-4 text-gray-500'>I am a Junior Web Programmer experienced in React JavaScript, Tailwind CSS, and HTML. A Passionate developer who creates captivating web experiences. Let's innovate together!</p>
                    <h1 className='font-medium md:text-2xl text-lg text-slate-600 my-4'>Tech Stack</h1>
                    <div className=' flex flex-row justify-evenly md:justify-start md:gap-8 items-center'>
                        <div className='items-center md:shadow-none shadow-xl p-4 md:p-0 rounded-xl'>
            ...
            <div className='md:w-1/2 hover:-rotate-3 hover:bg-slate-50 duration-500 transition all md:mt-0 mt-4  rounded-full shadow-xl h-[350px] md:h-4/5 overflow-hidden w-full flex items-center justify-center'>
                <img className='object-cover w-full h-full object-top' src={own} alt='' />
            </div>
        </section>
    )
}
