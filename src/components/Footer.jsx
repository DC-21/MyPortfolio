        ...
        <footer class="text-gray-600 body-font bg-slate-500">
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                <a href='' class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-10 h-10 text-white p-2 bg-slate-500 shadow-md border-white border rounded-full" viewBox="0 0 24 24">
